...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 404.0, 348.0, 45.0, 45.0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-1::obj-4" : [ "pw1", "pw1", 0 ],
			"obj-1::obj-48" : [ "live.menu[6]", "live.menu", 0 ],
			"obj-1::obj-49" : [ "live.menu[7]", "live.menu", 0 ],
			"obj-1::obj-5" : [ "pw2", "pw2", 0 ],
			"obj-1::obj-9" : [ "interpolate[4]", "phase1", 0 ],
			"obj-3::obj-103" : [ "live.toggle[6]", "live.toggle", 0 ],
			"obj-3::obj-23" : [ "live.toggle[9]", "live.toggle", 0 ],
			"obj-3::obj-71" : [ "live.menu[81]", "live.menu[3]", 0 ],
			"obj-3::obj-76" : [ "live.menu[80]", "live.menu[3]", 0 ],
			"obj-3::obj-79" : [ "live.button[18]", "live.button", 0 ],
			"obj-3::obj-80" : [ "live.menu[83]", "live.menu[3]", 0 ],
			"obj-3::obj-83" : [ "live.menu[82]", "live.menu[3]", 0 ],
			"obj-3::obj-92" : [ "live.toggle[7]", "live.toggle", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
